    ...
    <div className="p-4 md:p-6 max-w-2xl space-y-8">
      ...
      <section className="rounded-lg border border-border bg-surface p-6">
        ...
        <dl className="mt-4 space-y-2">
          <div>
            <dt className="text-sm text-text-secondary">Nome</dt>
          ...
          <div>
            <dt className="text-sm text-text-secondary">Função</dt>
      ...
      <section className="rounded-lg border border-border bg-surface p-6">
        <h2 className="text-lg font-semibold text-text-primary">Assinatura</h2>
        {subscription ? (
          <div className="mt-4 space-y-2">
            <p className="text-sm text-text-secondary">
              Plano:{" "}
              <span className="text-text-primary">{subscription.planType}</span>
            </p>
            <p className="text-sm text-text-secondary">
              Status:{" "}
